...
export const SettingsPage: FC = () => {
  ...
  return <>
    ...
    <Typography component="p" sx={{ mt: 3 }}>
      <Link to="/settings/change-avatar" className="normal-link">アバター変更画面に移動する</Link>
    </Typography>
    ...
    <Typography component="p" sx={{ mt: 3 }}>
      <Link to="/settings/login-histories" className="normal-link">ログイン履歴確認画面に移動する</Link>
    </Typography>
    
    <Divider sx={{ mt: 4 }} />
    <Typography component="h2" variant="h5" sx={{ mt: 3 }}>アカウント削除</Typography>
    <Typography component="p" sx={{ mt: 3 }}>
      <Link to="/settings/delete-account" className="normal-link">アカウント削除確認画面に移動する</Link>
    </Typography>
