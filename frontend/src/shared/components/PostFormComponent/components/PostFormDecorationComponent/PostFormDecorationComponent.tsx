...
export const PostFormDecorationComponent: FC<Props> = ({ onInsert }) => {
  return <Stack direction="row" spacing={1.25} useFlexGap sx={{ mt: 1, flexWrap: 'wrap', ['& button']: { minWidth: 'auto', whiteSpace: 'nowrap' } }}>
    ...
    <Button variant="outlined" size="small" color="secondary" onClick={() => onInsert('<font size="★" color="#609"><b>', '</b></font>', ['3', '4', '5', '6'])}>紫</Button>
    ...
    <Button variant="outlined" size="small" color="inherit"   onClick={() => onInsert('<★ align="center">', '</★>', ['h1', 'h2', 'h3', 'h4', 'h5', 'h6'])}>中</Button>
    <Button variant="outlined" size="small" color="inherit"   onClick={() => onInsert('<★ align="right">', '</★>' , ['h1', 'h2', 'h3', 'h4', 'h5', 'h6'])}>右</Button>
  </Stack>;
};
